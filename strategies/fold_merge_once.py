...
class FoldMergeOnce(MergeStrategy):
    ...
    def generate_genotype(self, config):
        ...
        for layer_idx in range(self.candidate_layers):
            ...
            if (layer_idx not in remove_indices) and (layer_idx != len(self.num_hidden_layers) - 1) and (layer_idx + 1 in remove_indices):
    ...
    def get_config(self):
        ...
        for layer_idx in range(self.num_hidden_layers):
            ...
            if layer_idx != len(self.num_hidden_layers) - 1:
                ...
                if remove_count!=0:
                    ...
                    if anchor_conditions:
                        anchor_condition = OrConjunction(*anchor_conditions)
                        cs.add_condition(anchor_condition)
    ...
    def get_initial_params(self):
        ...
        for option_name, remove_list in remove_list_options.items():
            ...
            for layer_idx in range(total_layers):
                ...
                if (layer_idx not in remove_list) and (layer_idx != len(self.num_hidden_layers) - 1) and (layer_idx + 1 in remove_list):
